...
export const ENV = {
  ...
  BAND_SUBMISSION_ENDPOINT: extra.BAND_SUBMISSION_ENDPOINT ?? '',
  PREMIUM_CHECKOUT_URL: extra.PREMIUM_CHECKOUT_URL ?? '',
  PREMIUM_ANNUAL_CHECKOUT_URL: extra.PREMIUM_ANNUAL_CHECKOUT_URL ?? '',
  TIP_CHECKOUT_URL: extra.TIP_CHECKOUT_URL ?? '',
  AMAZON_ASSOCIATE_TAG: extra.AMAZON_ASSOCIATE_TAG ?? '',
};
